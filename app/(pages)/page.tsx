          ...
          <div className="mt-8">
            ...
            <p className="mt-4">
              ...
              <span className="text-emerald-500">
                pseudonative irl criteria
              </span>
              , and finally,{" "}
              <span className="text-lime-500">custom criteria</span>.
            </p>
            <p className="mt-4">
            ...
            <p className="mt-2">
              ...
              based on questions you create yourself before answering them.
              Their answers are visible to all your friends, just like native
              criteria.
            </p>
            <p className="mt-2">
              <span className="text-emerald-500">
            ...
            <p className="mt-2">
              <span className="text-lime-500">Custom criteria</span> are based
              on questions you create yourself before answering them as well,
              just like pseudonative and pseudonative irl criteria. They differ
              in that you can manually select which friend to share them to, or
              choose to not share them and to keep these criteria for yourself
              if you so desire.
            </p>
